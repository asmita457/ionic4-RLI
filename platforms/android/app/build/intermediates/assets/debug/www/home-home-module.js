...
module.exports = ".welcome-card {\n  display: flex;\n  flex-direction: row;\n  overflow: hidden;\n  border-radius: 2%;\n  justify-content: center; }\n\n.background-color {\n  background-color: #E3A214;\n  cursor: pointer;\n  border: none;\n  width: 100%; }\n\n.h4-text {\n  text-align: left;\n  padding-left: 10px; }\n\n.row {\n  display: -moz-flex;\n  display: flex;\n  padding: 5px;\n  width: 100%; }\n\n.menubutton {\n  color: black !important; }\n\n.titleclass {\n  color: black !important; }\n\n.Helpclass {\n  color: black !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
    ...
    HomePage.prototype.getActiveEvent = function () {
        ...
        if (this.networkProvider.getNetworkStatus() == 'Online') {
            ...
            this.dataServices.getActiveEventsApi(localStorage.getItem('UserID')).then(function (result) {
                ...
                if (error.url == null) {
                    _this.eventName = localStorage.getItem('EventName');
                    _this.yardName = localStorage.getItem('YardName');
                    _this.status = localStorage.getItem('ActiveEventStatus');
                    _this.yardArray = localStorage.getItem('YardArray');
