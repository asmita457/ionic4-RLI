...
var NewreceiptsPage = /** @class */ (function () {
    function NewreceiptsPage(alertController, actionSheetController, imagePicker, camera, router, dataServices, loadingController, networkProvider, transfer, file) {
    ...
    NewreceiptsPage.prototype.getReceiptArray = function () {
        ...
        for (var i = 0; this.yardArray.length > i; i++) {
        ...
        if (this.networkProvider.getNetworkStatus() == 'Online') {
            ...
            this.dataServices.getCategories().then(function (result) {
                ...
                if (_this.responseData.status == 200) {
                    ...
                    _this.categoryPlaceholder = _this.categoryValues[0];
    ...
    NewreceiptsPage.prototype.getCreditCardDetail = function () {
        ...
        if (this.networkProvider.getNetworkStatus() == 'Online') {
            this.presentLoading();
            this.dataServices.getCreditCardDetailApi(this.number).then(function (result) {
                _this.responseData = result;
                console.log("Credit Card", _this.responseData);
                var creditIdStatus = _this.responseData.status;
                if (creditIdStatus == 'success') {
                    var creditCardId = _this.responseData.credit_id;
    ...
    NewreceiptsPage.prototype.takePhoto = function (sourceType) {
        ...
        this.camera.getPicture(options).then(function (imageData) {
            ...
            _this.receiptInfo.image = base64Image;
        }, function (err) {
            // Handle error
        });
    };
    ...
    NewreceiptsPage.prototype.submitReceiptData = function () {
        ...
        fileTransfer.download(this.photos, this.file.dataDirectory + imageName, true, options).then(function (result) {
