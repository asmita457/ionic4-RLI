...
var ForgotpasswordPage = /** @class */ (function () {
    function ForgotpasswordPage(router, alertCtrl, forgotservice, toastCtrl, loadingController, networkProvider) {
        this.router = router;
    ...
    ForgotpasswordPage.prototype.resetPassword = function () {
        ...
        if (this.networkProvider.getNetworkStatus() == 'Online') {
            ...
            if (this.mobno == "" || this.mobno == undefined) {
                this.presentAlert('Sorry', 'Please enter mobile number');
                return;
            }
            if (this.mobno.length != 10) {
                this.presentAlert('Sorry', 'Please enter valid mobile number');
                return;
            }
